      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <ThemedView style={styles.header}>
          ...
          <ThemedText style={styles.subtitle}>
            Share your route or shipment. For now, use airport IDs from your admin
            dashboard; autocomplete is coming soon.
          </ThemedText>
        </ThemedView>
        ...
        <VStack space="lg" className="w-full">
          ...
          <FormControl isInvalid={Boolean(validationErrors.originId)} size="sm">
            <FormControlLabel>
              <FormControlLabelText>
                <ThemedText>Origin airport ID</ThemedText>
              </FormControlLabelText>
            </FormControlLabel>
            <Input>
              <InputField
                ...
                placeholder="UUID for origin airport"
                autoCapitalize="none"
                autoCorrect={false}
                accessibilityLabel="Origin airport ID"
                accessibilityHint="Paste the airport UUID for the departure city"
              />
            </Input>
            <FormControlHelper>
              <FormControlHelperText>
                Use the airports table UUIDs. Search/autocomplete is coming.
              </FormControlHelperText>
            </FormControlHelper>
          ...
          <FormControl isInvalid={Boolean(validationErrors.destinationId)} size="sm">
            <FormControlLabel>
              <FormControlLabelText>
                <ThemedText>Destination airport ID</ThemedText>
              </FormControlLabelText>
            </FormControlLabel>
            <Input>
              <InputField
                ...
                placeholder="UUID for destination airport"
                autoCapitalize="none"
                autoCorrect={false}
                accessibilityLabel="Destination airport ID"
                accessibilityHint="Paste the airport UUID for the arrival city"
              />
            </Input>
